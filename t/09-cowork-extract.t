...
$temp = $temps->[0];
$extres = $ext->extract($temp,"A B C D E F");
is $extres->{'value'}, 'D';
$extres = $ext->extract($temp,"A B C E F");
...
$temp = $temps->[0];
$extres = $ext->extract($temp,"가격 1200 원");
is $extres->{'value'}, '1200';
$extres = $ext->extract($temp,"가격 1300 원");
is $extres->{'value'}, '1300';

$str1 = [qw"I am perl, and I am smart"];
$str2 = [qw"I am khs, and I am a perlmania"];
